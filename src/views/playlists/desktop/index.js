...
const Playlist = () => {
  ...
  const getPlaylists = async () => {
    try {
      ...
      const first6Followed = followedPlaylists.slice(0, 6);
      setTopFollowedPlaylists(first6Followed);
      ...
      const first6browsePlaylists = browsePlaylists.slice(0, 6);
      setTopBrowsePlaylists(first6browsePlaylists);
                      ...
                      { followedPlaylists.length > 0 ?
                        <Card position="fixed" style={{marginBottom:'32px',  padding:'16px'}}>
                          <CardContent >
                            <Grid container spacing={4}>
                              <Grid item xs={12} style={{paddingBottom: '0px'}}>
                                <SubscriptionsIcon size='small' style={{paddingRight:'16px', float:'left'}} />
                          ...
                          <CardContent >
                            <Grid container spacing={4}>
                              ...
                              <PublicIcon size='small' style={{paddingRight:'16px', float:'left'}} />
                                <Typography variant='h4' style={{float: 'left', }}>Browse All Playlists</Typography>
                              </Grid>  
                              <Grid item xs={12}>
                                <Divider />
                              </Grid>
